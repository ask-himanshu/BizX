...
{
    public partial class TravelRequestPage : ContentPage
    {
        ...
        private string KYCSupportingDoc, KYCSupportingDocName = "";
        ...
        private IEnumerable<GetCurrencyMasters> GetCurrencyResponse, InternationalGetCurrencyResponse;
        //Added new
        ...
        private void InitViews()
        {
            ...
            GetAllCountries();
            GetUnitLocations();
           TravelKYCDocumentById(0, (Convert.ToInt32(Preferences.Get(Constants.UID, -1))), 1);
            GetDocumentType();
            GetVisaType();
            TenantName();
        ...
        private void Handle_Domestic_Check_Click(Object sender, EventArgs e)
        {
            ...
            if (isDomestic.IsChecked)
            {
                ...
                VisaCountryLine.IsVisible = false;
                VisaGrid.IsVisible = false;
        ...
        private void Handle_International_Check_Click(Object sender, EventArgs e)
        {
            ...
            if (isInternational.IsChecked)
            {
                ...
                VisaCountryLine.IsVisible = true;
                VisaGrid.IsVisible = true;
            ...
            switch (viewNumber)
            {
                case 1:
                    ...
                    if (reasonEntry.Text != null && commentsEntry.Text != null)
                    {
                        ...
                        if(mTravelType =="International")
                        {
                            if (homeManagerEntry.Text.Equals("") || onsiteManagerEntry.Text.Equals("") || visatype.Equals(""))
                            {
                                DisplayAlert("Alert", "Please fill all the fields", "Ok");
                                return;
                            }
                            foreach( var x in GetCurrencyResponse)
                            {
                                if(x.attributeElementName=="INR")
                                {
                                    x.attributeElementName = "YUM";
                                    break;
                                }
                            }
                        ...
                        if (visatype == "Others")
                        {
                            if (othersvisa.Text == null)
                            {
                                DisplayAlert("Alert", "Please fill all the fields", "Ok");
                                return;
                            }
                            visaname = othersvisa.Text;
                ...
                case 2:
                    if (mTripType.Equals("OneWayTrip") && (modeOfTransport.SelectedIndex == -1 || fromCountryName.Equals("")
                                                          || fromCityName.Equals("") || toCountryName.Equals("")
                                                           || toCityName.Equals("") || departureTime.Equals("")|| mDepartureTimeSelectedItem.Equals("")
                        ...
                        return;
                                                      ...
                                                      || fromCityName.Equals("") || toCountryName.Equals("")
                                                       || toCityName.Equals("") || departureTime.Equals("")
                                                        ...
                                                        || mDepartureTimeSelectedItem1.Equals("")
                                                        || toCityName1.Equals(""))))
                    {
                ...
                case 4:
                    if (isAdvanceReq)
                    {
                        if (mTravelType == "International")
                        {
                            if (visaname == "H1 B" || visaname == "H1 B Transfer" || visaname == "H1 B Outside the Country" || visaname == "L1 A Individual" || visaname == "L1 A Blanket")
                            {
                                if (Convert.ToInt32(cashAmtEntry.Text) > 3000)
                                {
                                    cashAmtEntry.Text = "0";
                                    DisplayAlert("Alert", "Advance Amount cannot be more than 3000", "Ok");
                                    return;
                ...
                case 6:
                    if (mTravelType=="International")
                    {
                        if (mTravelKYCDocumentByIdModel.datalist.Count < 5)
                        {
                            DisplayAlert("Alert", "Please upload all the Documents", "Ok");
                            return;
                        }
                    }
        ...
        private void SwitchBackView()
        {
...

            {
                ...
                case 2:
                    if (visatype == "Others")
                    {
                        VisaOthersGrid.IsVisible = true;

                    }
                    else
                    {
                        VisaOthersGrid.IsVisible = false;
                    }
        ...
        {
            GetCurrencyResponse = await App.RestService.GetResponse<IEnumerable<GetCurrencyMasters>>(Constants.URL +
            ...
            if (GetCurrencyResponse != null)
            {
                    ...
                    var y=GetCurrencyResponse.Where(x => x.attributeElementName != "INR");
        ...
        private async void CreateApprovalHeirarchy()
        {
            ...
            else if (mTravelType.Equals("International"))
            {
                if (mBillableType.Equals("Billable"))
                {
                    ...
                    approvalHierarchyNew.ceo = 6;
                    approvalHierarchyNew.ceouid = (int)empDetailModel.ceoUID;

                    approvalHierarchyNew.topLevel = 5;
                    approvalHierarchyNew.topLevelUID = (int)empDetailModel.topLevelUID;
                }
                else
                {
                    approvalHierarchyNew.noofApprovals = 6;
        ...
        private async void TenantName()
        {
            ...
            {
                var tenantName = GetentityDetailResponse.datalist.Find(x => x.tenantMasterId == Convert.ToInt32(Preferences.Get(Constants.TENANT_ID, -1)));
                entityShortName = tenantName.entityShortName;
            }
        }
        ...
        private async void InsertTravelRequestJson()
        {
            ...
            if (ValidateTokenResponse == null)
            {
                ...
                insertTravelRequestModel.entityShortName = entityShortName;
                insertTravelRequestModel.visaCategory = visaname;
        ...
        private async void TravelKYCDocumentById(int TravelMasterId, int CreatedBy, int Type)
        {
            ...
            {
                travelkyctab.IsVisible = false;
                TravelKYCDocumentList.IsVisible = false;
            }
            else
            {
                travelkyctab.IsVisible = true;
                TravelKYCDocumentList.IsVisible = true;
            }
        ...
        async void KYC_Attachment_Download(Object sender, EventArgs args)
        {
            ...
            var details = await App.RestService.GetResponse<GetTravelKYCDocumentById>
                                             (Constants.URL + "Travel/GetTravelKYCDocumentById?TravelMasterId=" +
                                             Util.Encode(Convert.ToString(localTravelKYCDetailId)) + "&CreatedBy=" + Util.Encode(Convert.ToString((int)mTravelKYCDocumentByIdModel.datalist[0].CreatedBy)) + "&Type=" + Util.Encode(Convert.ToString(3)));
            if (details != null)
            {
                if (Device.RuntimePlatform == Device.iOS)
                {
        ...
        {
            if ((identityno.Text==null) || KYCSupportingDoc.Equals("") || documentType==0)
            {
                await DisplayAlert("Alert", "Please fill all the required fields", "Ok");
                return;
            }
            ...
            if (ValidateTokenResponse == null)
            {
                ...
                insertKycDocumentModel.attributeElementId = documentType;
                ...
                insertKycDocumentModel.identityNo = identityno.Text;
                insertKycDocumentModel.remarks = kycremarks.Text;
                insertKycDocumentModel.supportingDoc = KYCSupportingDoc;
                insertKycDocumentModel.supportingDocName = KYCSupportingDocName;
                ...
                if (TravelKycDocumentRequestResponse != null && TravelKycDocumentRequestResponse.authenticated)
                {
                    ...
                    await DisplayAlert("Success", "Travel request Uploaded successfully", "Ok");
                    File_Name3.Text = "";
                    KYCSupportingDocName = "";
                    KYCSupportingDoc = "";
                    kycremarks.Text = "";
                    identityno.Text = "";
        ...
        private void ResetKYCDocuments(object sender,EventArgs e)
        {
            File_Name3.Text = "";
            KYCSupportingDocName = "";
            KYCSupportingDoc = "";
           ...
           try
            {
                ...
                if (pickedFile != null)
                {
                     File_Name.Text = pickedFile.FileName;
                        ...
                        KYCSupportingDocName = pickedFile.FileName;
                        KYCSupportingDoc = Convert.ToBase64String(pickedFile.DataArray);
                        }
        ...
        public void PickerVisa_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                visatype = item.attributeElementName;
                visaname= visatype;
                if(visatype=="Others")
                {
                    VisaOthersGrid.IsVisible = true;
        ...
        public void PickerDocumentType_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (DocumentType.SelectedIndex == -1)
            {
                
            }
            else
            {
                var item = (ContentList)DocumentType.SelectedItem;

                documentType = (int)item.id;
        ...
        {
            var GetVisaType = await App.RestService.GetResponse<GetCurrencyMasterss>(Constants.URL +
                "Onboarding/GetQualificationAndCandidateAttachmentMasters?TenantMasterId=" +
                Util.Encode(Convert.ToString(Preferences.Get(Constants.TENANT_ID, -1))) + "&AttributeMasterId=" + Util.Encode(Convert.ToString(0)) + "&displayShortName=" + "USAVisaType");

            if (GetVisaType != null)
            {
                VisaType.ItemsSource = (System.Collections.IList)GetVisaType.contentList;

            }


        }
         private async void GetDocumentType()
        {
            var GetDocumentType = await App.RestService.GetResponse<GetCurrencyMasterss>(Constants.URL +
                "Onboarding/GetQualificationAndCandidateAttachmentMasters?TenantMasterId=" +
                Util.Encode(Convert.ToString(Preferences.Get(Constants.TENANT_ID, -1))) + "&AttributeMasterId=" + Util.Encode(Convert.ToString(0)) + "&displayShortName=" + "Travel-Document");

            if (GetDocumentType != null )
            {
                DocumentType.ItemsSource = (System.Collections.IList)GetDocumentType.contentList;
