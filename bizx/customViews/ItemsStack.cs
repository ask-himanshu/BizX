...
namespace bizx.customViews
{
    public class ItemsStack : StackLayout
    {
        ...
        protected virtual void SetItems()
        {
            ...
            var isObs = ItemsSource.GetType().IsNested && ItemsSource.GetType().GetGenericTypeDefinition() == typeof(ObservableCollection<>);
            if (isObs)
            {
        ...
        public Action<object, ItemTappedEventArgs> ItemTapped { get; internal set; }
