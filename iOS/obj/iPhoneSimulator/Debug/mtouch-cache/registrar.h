...
@class Xamarin_iOS__PushToTalk_PTChannelManagerDelegate;
@class Xamarin_iOS__PushToTalk_PTChannelRestorationDelegate;
...
@interface bizx_iOS_customViews_MyPickerDelegate : NSObject<UIPickerViewDelegate> {
}
	-(void) release;
	-(id) retain;
	-(GCHandle) xamarinGetGCHandle;
...
@interface Xamarin_iOS__PushToTalk_PTChannelManagerDelegate : NSObject<PTChannelManagerDelegate> {
}
	-(id) init;
@end

@interface Xamarin_iOS__PushToTalk_PTChannelRestorationDelegate : NSObject<PTChannelRestorationDelegate> {
}
	-(id) init;
@end
