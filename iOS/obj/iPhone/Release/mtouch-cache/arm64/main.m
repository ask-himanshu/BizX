...
extern void *mono_aot_module_bizx_iOS_info;
...
extern void *mono_aot_module_bizx_info;
...
extern void *mono_aot_module_SuaveControls_FloatingActionButton_info;
extern void *mono_aot_module_Plugin_DownloadManager_Abstractions_info;
...
extern void *mono_aot_module_Plugin_LatestVersion_info;
...
extern void *mono_aot_module_SuaveControls_FloatingActionButton_iOS_info;
extern void *mono_aot_module_Rg_Plugins_Popup_IOS_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_bizx_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_bizx_info);
	...
	mono_aot_register_module (mono_aot_module_SuaveControls_FloatingActionButton_info);
	mono_aot_register_module (mono_aot_module_Plugin_DownloadManager_Abstractions_info);
	...
	mono_aot_register_module (mono_aot_module_Plugin_LatestVersion_info);
	...
	mono_aot_register_module (mono_aot_module_SuaveControls_FloatingActionButton_iOS_info);
...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	xamarin_open_and_register ("SuaveControls.FloatingActionButton.iOS.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "bizx.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
