...
namespace bizx.iOS.customViews
{
    public class NavigationPageRenderer : PageRenderer
    {
        public override void ViewWillAppear(bool animated)
        {
            ...
            if (((CustomNavigationPage)Element).EnableBackButtonOverride)
            {
        ...
        //    backBtn.Font = UIFont.FromName("Ubuntu-M", (nfloat)17);
            ...
            backBtn.TouchDown += (sender, e) =>
            {
                ...
                if (((CustomNavigationPage)Element)?.CustomBackButtonAction != null)
                {
                    ((CustomNavigationPage)Element)?.CustomBackButtonAction.Invoke();
                }
            };
